...
function CloudOops() {
    ...
    return (
        ...
        <Helmet>
          <title>Devops Course | Devops Training in Bangalore | Cloudops</title>
          <meta name="description" content="Looking for the DevOps Course In Bangalore? Join Be Practical for top-notch DevOps Training In Bangalore. Gain essential skills. Enroll now!" />
          <meta name="keywords" content="Devops Course" />
          <link rel="canonical" href="https://be-practical.com/cloudops-devops-course-in-bangalore" />
        </Helmet>
