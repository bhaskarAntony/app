...
function DataScienceCourse() {
    ...
    return (
        <section className='overflow-hidden'>
          <Helmet>
          <title>Best Data Science Courses | Data Science Course In Bangalore</title>
          <meta name="description" content="Be-practical provides Data Science Course In Bangalore. Enroll in Best Data Science Courses which gives you industry relevant and hands on training." />
          <meta name="keywords" content="Data Science Courses" />
          <link rel="canonical" href="https://be-practical.com/data-science-course-in-bangalore" />
        </Helmet>
